...
class Filmwork(UUIDMixin, TimeStampedMixin):
    ...
    rating = models.FloatField(_('rating'), default=0.0, validators=[MinValueValidator(0),MaxValueValidator(10)])
...
class PersonFilmWork(UUIDMixin):
    ...
    role = models.TextField('role', null=True, choices=RoleType.choices, default=RoleType.ACTOR)
    created = models.DateTimeField(auto_now_add=True)
